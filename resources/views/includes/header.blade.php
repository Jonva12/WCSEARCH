      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#services">Opiniones</a>
            </li>
            <li class="nav-item">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li id="login"><a href="#"><i class="fas fa-pencil-alt" id="logicon"></i>  Registrarse </a></li>
            <li id="login"><a href="#"><i class="fas fa-sign-in-alt" id="logicon"></i>  Loguear </a> </li>
          </ul>
        </div>
